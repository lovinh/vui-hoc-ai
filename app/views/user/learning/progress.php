...
<section class="course_details_area section_gap">
    <div class="container">
        <div class="row">
            <h2>You progress: {{ $model['complete'] }}%</h2>
        </div>
        <div class="row">
            <div class="col-lg-8 course_details_left">
                <h2 class="title">Course Progress Detail</h2>
                        ...
                        <ul class="course_list">
                            ...
                            <li class="d-flex" style="flex-direction: column; ">
                                <a class="justify-content-between d-flex" data-toggle="collapse" href="#{{ 'lesson' . $key }}" role="button" aria-expanded="false" aria-controls="collapseExample">
                                    ...
                                    <span style="color: #007bff; font-weight: 600;">{{ $lesson['complete'] }}%</span>
                                </a>
                                <div class="collapse show m-3" id="{{ 'lesson' . $key }}">
                                    <ul>
