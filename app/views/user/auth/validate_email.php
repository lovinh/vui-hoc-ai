        ...
        <div class="forms">
            <div class="form-content">
                <div class="signup-form">
                    <div class="title">One more step to complete!</div>
                    <form method="post" action="{{ route_url('user.auth.validating_email') }}">
                        <div class="input-boxes">
                            ...
                            <div class="text sign-up-text">Do not see your code? <a href="{{ route_url('user.auth.validating_email_send_again') }}" style="font-weight: 800;">Send again</a></div>
                        </div>
                    </form>
                </div>
            </div>
