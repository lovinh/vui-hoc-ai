        ...
        <div class="forms">
            <div class="form-content">
                <div class="signup-form">
                    ...
                    <form method="post" action="{{ route_url('user.auth.sign_up') }}">
                        <div class="input-boxes">
                            ...
                            <div class="input-box">
                                ...
                                <input type="text" name="sign_up_first_name" value="{{ $data['old_first_name'] ?? false }}" placeholder="Your first name">
                                <input type="text" name="sign_up_last_name" value="{{ $data['old_last_name'] ?? false }}" placeholder="Your last name">
                            </div>
                            <div class="input-box">
                                <i class="fas fa-envelope"></i>
                                <input type="text" name="sign_up_email" value="{{ $data['old_email'] ?? false }}" placeholder="Enter your email">
                            </div>
                            <div class="input-box">
                                <i class="fas fa-lock"></i>
                                <input type="password" name="sign_up_password" value="" placeholder="Enter your password">
                            </div>
                            <div class="input-box">
                                <i class="fas fa-check"></i>
                                <input type="password" name="sign_up_repassword" value="" placeholder="Re-enter your password">
                            </div>
                            <div class="button input-box">
                                <input type="submit" value="Submit">
                            </div>
                            <div class="text sign-up-text">Already have an account? <a href="{{ route_url('user.auth.index') }}" style="font-weight: 800;">Signin now</a></div>
                        </div>
                    </form>
                </div>
            </div>
