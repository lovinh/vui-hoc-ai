        ...
        <div class="forms">
            <div class="form-content">
                <div class="signup-form">
                    ...
                    <form method="post" action="{{ route_url('user.auth.forget_password_email_input') }}">
                        <div class="input-boxes">
                            @if (!empty($err))
                            <div class="alert alert-danger text-center" role="alert">{{ $err }}</div>
                            @endif
                            <div>Enter your email address that belong to your account:</div>
                            <div class="input-box">
                                <i class="fas fa-envelope"></i>
                                <input type="text" name="forget_password_email" value="" placeholder="Enter your email" required>
                            </div>
                            <div class="button input-box">
                                <input type="submit" value="Submit">
                            </div>
                            <div class="text sign-up-text">Remember again? <a href="{{ route_url('user.auth.index') }}" style="font-weight: 800;">Sign in</a></div>
                        </div>
                    </form>
                </div>
            </div>
