                ...
                <div class="login-form">
                    ...
                    <form method="post" action="{{ route_url('user.auth.sign_in') }}">
                        <div class="input-boxes">
                            ...
                            <div class="text"><a href="{{ route_url('user.auth.forget_password') }}" style="color: #f8b600;">Forgot password?</a></div>
                            <div class="button input-box">
                                <input type="submit" value="Submit">
                            </div>
                            <div class="text sign-up-text">Don't have an account? <a href="{{ route_url('user.auth.register') }}" style="font-weight: 800;">Sigup now</a></div>
                        </div>
                    </form>
                </div>
            </div>
